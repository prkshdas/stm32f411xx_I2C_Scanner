 ...
 */
typedef struct {
    USART_RegDef_t *pUSARTx;        // Pointer to the USARTx peripheral base address
    ...
    uint8_t TxBusyState;            // TX state (@USART_BusyState)
    uint8_t RxBusyState;            // RX state (@USART_BusyState)
} USART_Handle_t;
...
/* For more information about the APIs, check function definitions in the driver source file */
